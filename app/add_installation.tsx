    ...
    try {
        ...
        const machineRows = addedMachines.map((m, index) => `
            <tr>
                ...
                <td>
                    <b>${m.product}</b>
                    <div class="model-sub">Model: ${m.model || '-'}</div>
                </td>
                <td><b>${m.serialNo}</b></td>
                <td>${m.warrantyYears ? `${m.warrantyYears} Yr${m.warrantyYears > 1 ? 's' : ''} — ` : ''}Exp: ${m.warrantyExpiry || '-'}</td>
            </tr>
        `).join('');
        ...
        <html>
          ...
          <body>
            ...
            <div class="doc-band">
              ...
              <div class="doc-meta">
                <div>Report No: <b>${installId}</b></div>
                <div>Install Date: <b>${formatDate(installDate)}</b></div>
              </div>
            </div>
            ...
            <div class="sheet">
              <div class="grid">
                <div class="card">
                  ...
                  <div class="row"><span class="k">Hospital / Client</span><span class="v">${hospital}</span></div>
                  <div class="row"><span class="k">Address</span><span class="v">${address || '-'}${city ? ', ' + city : ''}</span></div>
                  <div class="row"><span class="k">Department</span><span class="v">${department || '-'}</span></div>
                </div>
                <div class="card">
                  <div class="card-label">CONTACT PERSON</div>
                  <div class="row"><span class="k">Name</span><span class="v">${contactPerson || '-'}</span></div>
                  <div class="row"><span class="k">Mobile</span><span class="v">${mobile || '-'}</span></div>
                  <div class="row"><span class="k">Engineer</span><span class="v">${engineer || '-'}</span></div>
                </div>
              </div>
              ...
              <div class="footer">
                ...
                <div class="sign-box">
                  <div class="sign-sub" style="margin-bottom:6px;">${engineer || ''}</div>
                  ${signatureHTML}
                  <div class="sign-line"></div>
